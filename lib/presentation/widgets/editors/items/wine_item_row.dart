...
class WineItemRow extends StatefulWidget {
  const WineItemRow({
    super.key,
  ...
  final int itemIndex;
  final WineItem item;
  final ValueChanged<WineItem> onChanged;
  final VoidCallback onDelete;

  @override
  State<WineItemRow> createState() => _WineItemRowState();
}

class _WineItemRowState extends State<WineItemRow> {
  ...
  @override
  void didUpdateWidget(WineItemRow oldWidget) {
